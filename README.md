...
A full-featured **Spring Boot-based E-Commerce Backend** built with clean architecture, security best practices, and real-world workflows.
This project covers product management, cart & order processing, authentication with JWT, email notification, password recovery, and more.
